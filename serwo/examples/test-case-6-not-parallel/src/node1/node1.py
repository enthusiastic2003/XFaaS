...
def function(serwoObject ) -> SerWOObject:
    try:
        ...
        places_prompt = (
            ...
            f"Suggest exactly 6 must-visit place in {place}. "
            f"The JSON must have one key: 'places', and the value must be a list containing a 2 strings. "
            f"Example: {{\"places\": [\"Qutub Minar\", \"Red Fort\", \"Taj Mahal\", \"Sundarban\", \"Victoria Memorial\", \"Aligarh Zoo\"]}}. Do not include explanations, formatting, or any additional text."
        )
